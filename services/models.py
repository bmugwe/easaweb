...
class airwaybill(models.Model):
    ...
    # assigned_to = models.ForeignKey(User, verbose_name=("assigneduser"), on_delete=models.CASCADE)
    timestamp_updated = models.DateTimeField(auto_now=True)
    Airport_of_departure= models.CharField(max_length=150, default=False)
    AIRPORT_OF_DEST= models.CharField(max_length=150, default=False)
    Airport_of_destination= models.CharField(max_length=150, default=False)
    c_airfreight_charges= models.CharField(max_length=150, default=False)
    c_charges_dest= models.CharField(max_length=150, default=False)
    c_other_charges_agent= models.CharField(max_length=150, default=False)
    c_other_charges_carrier= models.CharField(max_length=150, default=False)
    c_total_charges = models.CharField(max_length=150, default=False)
    c_tax = models.CharField(max_length=150, default=False)
    c_valuation_charges = models.CharField(max_length=150, default=False)
    Carrier_name = models.CharField(max_length=150, default=False)
    cheargeable_weight = models.CharField(max_length=150, default=False)
    ...
    other_charges_2 = models.CharField(max_length=150, default=False)
    p_airfreight_charges = models.CharField(max_length=150, default=False)
    p_charges_dest = models.CharField(max_length=150, default=False)
    p_currency_conversion = models.CharField(max_length=150, default=False)
    p_other_charges_agent = models.CharField(max_length=150, default=False)
    p_other_charges_carrier = models.CharField(max_length=150, default=False)
    p_tax = models.CharField(max_length=150, default=False)
    p_total_charges = models.CharField(max_length=150, default=False)
    p_valuation_charges = models.CharField(max_length=150, default=False)
    Rate_charge = models.CharField(max_length=150, default=False)
    Requested_routing = models.CharField(max_length=150, default=False)
    ROUTING_DEST = models.CharField(max_length=150, default=False)
    total_charge = models.CharField(max_length=150, default=False)
