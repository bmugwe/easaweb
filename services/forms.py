...
class Invoicetemplate(forms.Form):
    from_companyname = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    from_personname = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    from_phonenumber = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    from_town = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    from_emailaddress = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    to_consigneeename = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    to_phonenumber = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    to_address = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    to_town = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    disbursement_date = forms.DateField(widget=forms.TextInput(
        attrs={'placeholder': ('Disbursement Date'),
               'class': 'form-control',
    ...
    from_countries = forms.ChoiceField(choices=COUNTRIES, initial='0',
        widget=forms.Select(
    ...
    to_countries = forms.ChoiceField(choices=COUNTRIES, initial='0',
        widget=forms.Select(
        attrs={'class': 'form-control',
            'id': 'fromcountry',
            'data-parsley-required': "true",
    ...
    package_kind = forms.ChoiceField(choices=KIND_OF_PACKAGE, initial='0',
        widget=forms.Select(
        attrs={'class': 'form-control',
            'id': 'fromcountry',
            'data-parsley-required': "true",
    ...
    insur_amount = forms.CharField(widget = forms.TextInput(
        attrs={
    ...
    nvd = forms.CharField(widget = forms.TextInput(
        attrs={
            'placeholder': ('NVD'),
            'class': 'form-control',
            'id': 'nncdd',
    ...
    ncv = forms.CharField(widget = forms.TextInput(
        attrs={
            'placeholder': ('NCV'),
            'class': 'form-control',
            'id': 'ncv',
    ...
    handling_info = forms.CharField(required=False,
        widget=forms.Textarea(
            attrs={'placeholder': ('Handling Infor and remarks'),
               'class': 'form-control',
               'rows': '3',
               'id': 'HANDLING_INFO',
               'data-parsley-required': "true",
